...
<body>
	...
	<form id="inputForm" action="." method="post" class="input-form form-horizontal" >
		...
		<fieldset>
			<legend><small>修改监控邮件列表</small></legend>
			...
			<div class="control-group">
				...
				<div class="controls">
					<table class="table table-bordered table-condensed"  >
						<tbody>
							<c:forEach var="email" items="${apply.monitorMails}">
								<tr class="clone">
									<td><input type="text" value="${email.email }" id="monitorMails" name="monitorMails" class="required" maxlength="45" placeholder="...Email"></td>
