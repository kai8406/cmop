...
public class MailUtil {
	...
	private static final String PASS_URL = "http://localhost:8080/cmop/audit/operate?applyId=";
	private static final String DISAGREE_URL = "http://localhost:8080/cmop/audit/create/";
	
	public static void main(String[] args) {
		send(1, "", 1, "wenluping@sobey.com");
	}
...
//			messageHelper.setFrom("wlp_1@163.com");
//			messageHelper.setTo("wlp_oo@163.com");
			...
			html.append("你好！请审核以下内容：").append(sendTo);
			html.append(content);
			html.append("<li><b>审批操作</b></li><br>");
			html.append(Constant.BLANK_SPACE);
			html.append("<a href=\""+PASS_URL+applyId+"&user_id="+userId+"&result=1&opinion=\">1.同意</a>").append(Constant.BLANK_SPACE);
			html.append("<a href=\""+DISAGREE_URL+applyId+"\">2.不通过但继续</a>").append(Constant.BLANK_SPACE);
			html.append("<a href=\""+DISAGREE_URL+applyId+"\">3.不通过且退回</a><br>");
