...
import com.sobey.cmop.mvc.service.audit.AuditManager;
...
public class AuditController {
	...
	public String create(@RequestParam("applyId") Integer applyId, @RequestParam("user_id") Integer user_id,

	@RequestParam(value = "result", required = false) Integer result, Model model) {
