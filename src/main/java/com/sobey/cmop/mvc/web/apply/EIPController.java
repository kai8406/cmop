...
@Controller
@RequestMapping(value = "/apply/support/eip")
public class EIPController {

	private static final int DEFAULT_PAGE_NUM = 0;
	private static final int DEFAULT_PAGE_SIZE = 8;
	private static final String REDIRECT_SUCCESS_URL = "redirect:/apply/support/eip/";
	...
	public String detail(@PathVariable("id") Integer id, Model model) {
		model.addAttribute("apply", applyManager.findApplyById(id));
		model.addAttribute("computeList", applyManager.findComputeListByApplyId(id));
		return "apply/network/eipDetail";
	}
