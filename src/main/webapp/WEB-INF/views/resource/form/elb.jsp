...
<head>
	...
	<script>
		...
		$(document).on("click", "#ModalSave", function() {
			...
			//插入HTML文本
			$("#resourcesSecDIV dl").append(html);
...
<body>
	...
	<form id="inputForm" action="${ctx}/resources/update/elb/" method="post" class="input-form form-horizontal" >
		...
		<fieldset>
			...
			<div class="control-group">
				<label class="control-label" for="virtualIp">负载均衡虚拟IP</label>
				<div class="controls">
					<p class="help-inline plain-text">${elb.virtualIp}</p>
				</div>
			</div>
			...
			<!-- 生成的资源 -->
			<div id="resourcesSecDIV"><dl class="dl-horizontal">
