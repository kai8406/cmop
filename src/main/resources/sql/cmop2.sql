...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='资源申请表（也同样适合于服务变更，变更时先向此表写入一行新的记录，再向各个单项写入新的记录）';

/*Data for the table `apply` */

insert  into `apply`(`id`,`user_id`,`title`,`service_tag`,`service_type`,`priority`,`description`,`service_start`,`service_end`,`create_time`,`status`,`audit_flow_id`,`redmine_issue_id`) values (1,13,'wenlp-基础设施-20130218125954','北京',1,4,'北京WEBTV','2013-02-18','2013-05-18','2013-02-18 12:59:54',6,2,NULL);
...
CREATE TABLE `audit` (
  ...
  `result` varchar(1) DEFAULT NULL COMMENT '审批结果：1-同意；2-不同意但继续；3-不同意且退回',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='审批表';

/*Data for the table `audit` */

insert  into `audit`(`id`,`apply_id`,`service_tag_id`,`audit_flow_id`,`create_time`,`result`,`opinion`,`status`) values (1,1,NULL,3,'2013-02-18 13:01:19','1','',1),(2,1,NULL,1,'2013-02-18 13:01:30','1','',1),(3,1,NULL,2,'2013-02-18 13:01:35','1','',1);
...
CREATE TABLE `compute_item` (
  ...
  `inner_ip` varchar(45) DEFAULT NULL COMMENT '内网IP，从IP池获取',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='计算资源（虚拟机实例+物理机）明细表';

/*Data for the table `compute_item` */

insert  into `compute_item`(`id`,`apply_id`,`identifier`,`compute_type`,`os_type`,`os_bit`,`server_type`,`remark`,`inner_ip`,`old_ip`,`esg_id`,`elb_id`,`host_name`,`server_alias`,`host_server_alias`,`os_storage_alias`) values (1,1,'PCS-1PGhNdmN',1,5,2,7,'123',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(2,1,'PCS-zZ65dEhR',1,5,2,7,'321',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL),(3,1,'PCS-qg0o4w3s',1,4,1,4,'444',NULL,NULL,1,NULL,NULL,NULL,NULL,NULL);
...
insert  into `esg_rule_item`(`id`,`esg_id`,`protocol`,`port_range`,`visit_source`) values (1,1,'TCP','80','192.168.0.1');
...
insert  into `group_permission`(`group_id`,`permission`) values (1,'user:view'),(1,'group:view'),(1,'apply:view'),(1,'audit:view'),(1,'basicData:view'),(1,'operate:view'),(1,'department:view'),(1,'summary:view'),(2,'user:view'),(2,'group:view'),(2,'apply:view'),(2,'audit:view'),(2,'basicData:view'),(2,'operate:view'),(2,'department:view'),(2,'summary:view'),(3,'user:view'),(3,'group:view'),(3,'apply:view'),(3,'audit:view'),(3,'basicData:view'),(3,'operate:view'),(3,'department:view'),(3,'summary:view'),(4,'user:view'),(4,'group:view'),(4,'apply:view'),(4,'audit:view'),(4,'basicData:view'),(4,'operate:view'),(4,'department:view'),(4,'summary:view'),(5,'user:view'),(5,'group:view'),(5,'apply:view'),(5,'audit:view'),(5,'basicData:view'),(5,'operate:view'),(5,'department:view'),(5,'summary:view');
...
insert  into `network_esg_item`(`id`,`user_id`,`identifier`,`description`) values (1,NULL,'ESG-lVK78ORN','标准模板ESG');
...
CREATE TABLE `redmine_issue` (
  ...
  `service_tag_id` int(11) DEFAULT NULL COMMENT '服务标签ID，服务变更时写入',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='工单处理表（同步Redmine中的Issue表）';

/*Data for the table `redmine_issue` */

insert  into `redmine_issue`(`id`,`issue_id`,`tracker_id`,`project_id`,`subject`,`assignee`,`status`,`resource_id`,`apply_id`,`service_tag_id`) values (1,487,3,1,'wenlp-基础设施-20130218125954',4,1,NULL,1,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='资源总表（服务申请时向此表写入记录，服务变更时更新此记录的新申请ID和新服务ID）';

/*Data for the table `resources` */

insert  into `resources`(`id`,`user_id`,`service_type`,`service_tag_id`,`service_id`,`service_identifier`,`create_time`,`status`,`ip_address`,`usedby`) values (1,13,1,1,1,'PCS-1PGhNdmN','2013-02-18 13:02:12',-1,NULL,NULL),(2,13,1,1,3,'PCS-qg0o4w3s','2013-02-18 13:02:12',-1,NULL,NULL),(3,13,1,1,2,'PCS-zZ65dEhR','2013-02-18 13:02:12',-1,NULL,NULL);
...
insert  into `service_tag`(`id`,`user_id`,`name`,`priority`,`description`,`service_start`,`service_end`,`create_time`,`status`,`audit_flow_id`,`domain`,`contact`,`phonenum`,`redmine_issue_id`) values (1,13,'北京',4,'北京WEBTV','2013-02-18','2013-05-18','2013-02-18 13:02:12',-1,NULL,NULL,NULL,NULL,NULL);
