...
public class RedmineUtil {
	...
	private static final String projectKey = "3";
	private static final String redmineHost = "http://localhost/redmine";
	private static final String apiAccessKey = "e00a3db067a0dcba4d9c133b12d5bbf481916cd2"; //wenlp
	private static RedmineManager mgr = new RedmineManager(redmineHost, apiAccessKey);
...
//			issue.setDescription("具体的申请描述信息：description20GB");
			...
			mgr.createIssue(projectKey, issue); //默认：Sobey Cloud运营-->Iaas
...
//				List detail = journal.getJournalDetails();
//				System.out.println(" "+detail.size());
//				for (int j = 0; j < detail.size(); j++) {
//					JournalDetail journalDetail = (JournalDetail) detail.get(j);
//					System.out.println("    "+journalDetail.getName()+": "+journalDetail.getNewValue()+"-->"+journalDetail.getOldValue());
//				}
			}
