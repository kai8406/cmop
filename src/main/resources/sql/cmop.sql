...
insert  into `group_permission`(`group_id`,`permission`) values (1,'user:view'),(1,'user:edit'),(1,'group:view'),(1,'group:edit'),(2,'apply:view'),(2,'apply:edit'),(3,'audit:view'),(3,'audit:edit');
...
insert  into `user_group`(`user_id`,`group_id`) values (1,1),(5,2),(2,3),(3,3),(4,3);
